                ...
                {filteredCategories.map((category, index) => (
                    <div key={index} className="col-12">
                        <div
                            className="card p-3"
                            style={{
                                backgroundColor: category.bgColor || "#2b2b2b", // fallback color
                            }}
                        >
                            <div className="d-flex align-items-center">
                                ...
                                <div style={{ marginRight: "15px" }}>
                                    <img
                                        src={category.imageUrl || category.imgUrl || "https://via.placeholder.com/80"} // ✅ Corrected
                                        alt={category.name}
                                        className="category-image"
                                        onError={(e) => {
                                            e.target.src = "https://via.placeholder.com/80"; // fallback if broken
                                        }}
                                    />
                                </div>
                                ...
                                <div className="flex-grow-1">
                                    ...
                                    <p className="mb-0 text-white">
                                        {category.description || category.items}
                                    </p>
                                </div>
